        ...
        <section class="max-w-2xl px-1 py-2 mx-auto bg-white dark:bg-gray-900 rounded-lg">
            ...
            <main class="mt-2 mb-6">
                ...
                <p class="mt-2 leading-loose text-gray-600 dark:text-gray-300">
                    We have received the Service request from our customer <span class="text-blue-400">{{$name}}</span><br>
                    Email: <a href="mailto:{{$email}}" class="font-sm text-blue-600 hover:text-blue-500">{{$email}}</a>
                    <br>Phone Number: <a href="tel:{{$phone}}" class="font-sm text-blue-600 hover:text-blue-500">{{$phone}}</a>
                </p>
                <p class="mt-2 leading-loose text-gray-600 dark:text-gray-300">
            ...
            <footer class="mt-2">
                <p class="text-gray-500 dark:text-gray-400">
                    This email was sent from <a href="{{config('company.link')}}" class="text-blue-600 hover:underline dark:text-blue-400" target="_blank">{{config('company.name')}}</a>.
                </p>
