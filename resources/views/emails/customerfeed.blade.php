    ...
    <body class="p-1 bg-white dark:bg-slate-800 ">
        <div class="p-2 m-2 ">
            ...
            <section class="max-w-2xl px-2 py-2 mx-auto bg-white dark:bg-gray-900 rounded-lg">
                <header>
                    <img class="w-auto h-20 sm:h-22" src="https://familypoolserviceonline.com/images/logo/logoblck.svg"
                        width="80x" height="auto" alt="Company Logo">
                ...
                <main class="mt-4">
                    <p class="text-md text-gray-700 dark:text-gray-200">Hi Dear {{$name}},</p>
