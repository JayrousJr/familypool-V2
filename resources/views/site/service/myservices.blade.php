        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    @else
                    <p class="my-10 mx-20 text-md text-center font-normal text-gray-500 dark:text-gray-400">You
                        currently have no any service that you have requested at TechClouds, to make a request please <a
                            href="/service-request"
                            class="text-white bg-slate-500 rounded-md  px-2 hover:bg-slate-600 ">
                            Visit our service
