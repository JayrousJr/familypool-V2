            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <caption
                            ...
                            <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Browse a list of
                                the messages that you have sent to TechClouds, Please note that your messages
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <!-- <td class="px-6 py-4 text-right">
                                    <a href="{{route('messages.destroy', $message->id)}}" class="font-medium text-red-600 dark:text-red-500 hover:underline">Delete</a>
                                </td> -->
                            </tr>
                            @endforeach
                        </tbody>
                    ...
                    <p class="my-10 mx-20 text-md text-center font-bold text-gray-500 dark:text-gray-400">You currently
                        have not
                        sent any message to the Family Pool Service, You can not view any message for now.<br>To send
