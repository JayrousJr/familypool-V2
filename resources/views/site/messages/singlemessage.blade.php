                ...
                <form>
                    <div class="space-y-12">
                        <div class="border-b border-gray-900/10 px-8 mb-6">
                            <h2 class="text-base font-semibold leading-7 mt-3 text-gray-500 dark:text-gray-400">My
                                Message
                            </h2>
                            <p class="mt-3 text-sm font-bold text-gray-500 dark:text-gray-400">Message Sent
                            ...
                            <div class="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div class="col-span-full">
                                    <div class="mt-1">
                                        <textarea type="text" rows="3" readonly class="block w-full rounded-md border-0 py-1.5 text-white dark:text-white shadow-sm ring-1 ring-inset bg-slate-500 dark:bg-slate-500 ring-gray-300 placeholder:text-gray-400 focus:ring-2 text-md focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{$message->message}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
