            ...
            <div class="col-md-12 text-center ftco-animate">
                ...
                <form action="{{'apply_job'}}" method="post" novalidate>
                    ...
                    <div class="row gx-3 gy-2 align-items-center mb-3">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="name" id="inputFloating" placeholder="Jayrous King"
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="email" name="email" id="inputFloating" placeholder="name@email.com"
                    ...
                    <div class="row gx-3 gy-2 align-items-center mb-3">
                        <div class="col-md-4">
                            <div class="form-floating">
                                <input type="text" name="nationality" id="inputFloating" placeholder="Jayrous King"
                        ...
                        <div class="col-md-4">
                            <div class="form-floating">
                                <input type="text" name="state" id="inputFloating" placeholder="Jayrous King"
                        ...
                        <div class="col-md-4">
                            <div class="form-floating">
                                <input type="text" name="city" id="inputFloating" placeholder="Jayrous King"
                    ...
                    <div class="row gx-3 gy-2 align-items-center mb-3">
                        <div class="col-md-4">
                            <div class="form-floating">
                                <input type="text" name="street" id="inputFloating" placeholder="Jayrous King"
                        ...
                        <div class="col-md-4">
                            <div class="form-floating">
                                <input type="tel" name="phone" id="inputFloating" placeholder="000000 0000"
                        ...
                        <div class="col-md-4">
                            <div class="form-floating">
                                <input type="number" name="zip" id="inputFloating" placeholder="Jayrous King"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-12 check-controls">
                            ...
                            <div class="form-check check-modifier">
                                <input type="radio" name="gender" id="gender5"
                                    class="form-check-input @error('gender') is-invalid @enderror" value="Female">
                                <label class="form-check-label" for="service5">FEMALE</label>
                            </div>
                            <div class="form-check check-modifier">
                                <input type="radio" name="gender" id="gender"
                                    class="form-check-input @error('gender') is-invalid @enderror " value="Male">
                    ...
                    <div class="row gx-3 gy-2 align-items-center mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="number" name="age" id="inputFloating" placeholder="23"
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="date" name="birthdate" id="inputFloating" placeholder="Birth date"
                                    class="form-control @error('birthdate') is-invalid @enderror"
                                    value="{{old('birthdate')}}" min="1996-01-01" max="2005-12-31">
                    ...
                    <div class="row gx-3 gy-2 align-items-center mb-3">
                        ...
                        <div class="col-md-12 check-controls">
                            <div class="form-check check-modifier">
                                <input type="checkbox" name="days[]" id="inputFloating" placeholder=""
                                    class="form-check-input @error('days') is-invalid @enderror" value="MONDAY"
                                    required>
                            ...
                            <div class="form-check check-modifier">
                                <input type="checkbox" name="days[]" id="inputFloating" placeholder=""
                                    class="form-check-input @error('days') is-invalid @enderror" value="TUESDAY"
                                    required>
                            ...
                            <div class="form-check check-modifier">
                                <input type="checkbox" name="days[]" id="inputFloating" placeholder=""
                                    class="form-check-input @error('days') is-invalid @enderror" value="WEDNESDAY"
                                    required>
                            ...
                            <div class="form-check check-modifier">
                                <input type="checkbox" name="days[]" id="inputFloating" placeholder=""
                                    class="form-check-input @error('days') is-invalid @enderror" value="THURSDAY"
                                    required>
                            ...
                            <div class="form-check check-modifier">
                                <input type="checkbox" name="days[]" id="inputFloating" placeholder=""
                                    class="form-check-input @error('days') is-invalid @enderror" value="FRIDAY"
                                    required>
                            ...
                            <div class="form-check check-modifier">
                                <input type="checkbox" name="days[]" id="inputFloating" placeholder=""
                                    class="form-check-input @error('days') is-invalid @enderror" value="SATURDAY"
                                    required>
                    ...
                    <div class="row gx-3 gy-2 align-items-center mb-3">
                        ...
                        <div class="col-md-4">
                            <div class="form-floating">
                                <input type="time" name="starttime" id="inputFloating" placeholder="23"
                        ...
                        <div class="col-md-4">
                            <div class="form-floating">
                                <input type="time" name="endtime" id="inputFloating" placeholder="Birth date"
                                    class="form-control @error('endtime') is-invalid @enderror"
                                    value="{{old('endtime')}}" min="1996-01-01" max="2005-12-31">
                        ...
                        <div class="col-md-4">
                            <div class="form-floating">
                                <input type="date" name="startdate" id="inputFloating" placeholder=""
                                    class="form-control @error('startdate') is-invalid @enderror"
                                    value="{{old('startdate')}}" min="1996-01-01" max="2005-12-31">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="number" name="workperiod" id="inputFloating" placeholder="23"
                                    class="form-control @error('workperiod') is-invalid @enderror"
                                    value="{{ old('workperiod') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="number" name="workHours" id="inputFloating" placeholder="23"
                                    class="form-control @error('workHours') is-invalid @enderror"
                                    value="{{ old('workHours') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-12 check-controls">
                            ...
                            <div class="form-check check-modifier">
                                <input type="radio" name="socialsecurity" id="securityNumberRadio"
                                    class="form-check-input @error('socialsecurity') is-invalid @enderror" value="SSN"
                                    onclick="EnableDisableSocial();">
                                <label class=" form-check-label" for="securityNumberRadio">SS NUMBER</label>
                            </div>
                            <div class="form-check check-modifier">
                                <input type="radio" name="socialsecurity" id="einNumberRadio"
                                    class="form-check-input @error('socialsecurity') is-invalid @enderror " value="EIN"
                                    onclick="EnableDisableSocial();">
                    ...
                    <div class="row gx-3 gy-2 align-items-center mb-3">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="socialsecurityNumber" id="socialsecurityNumber"
                                    placeholder="Jayrous King"
                                    class="form-control @error('socialsecurityNumber') is-invalid @enderror"
                                    value="{{old('socialsecurityNumber')}}" disabled>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="einNumber" id="einNumber" placeholder="name@einNumber.com"
                                    class="form-control @error('einNumber') is-invalid @enderror"
                                    value="{{old('einNumber')}}" disabled>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-12 check-controls">
                            ...
                            <div class="form-check check-modifier">
                                <input type="radio" name="smoke" id="smoke"
                                    class="form-check-input @error('smoke') is-invalid @enderror" value="YES I SMOKE">
                                <label class="form-check-label" for="service5">YES</label>
                            </div>
                            <div class="form-check check-modifier">
                                <input type="radio" name="smoke" id="smoke"
                                    class="form-check-input @error('smoke') is-invalid @enderror"
                                    value="NO I DONOT SMOKE">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-12 check-controls">
                            ...
                            <div class="form-check check-modifier">
                                <input type="radio" name="licence" id="yes-licence"
                                    class="form-check-input @error('licence') is-invalid @enderror"
                                    value="YES I I HAVE DRIVING LICENCE" onclick="EnableDisableTB();">
                                <label class=" form-check-label" for="service5">YES</label>
                            </div>
                            <div class="form-check check-modifier">
                                <input type="radio" name="licence" id="no-licence"
                                    class="form-check-input @error('licence') is-invalid @enderror"
                                    value="NO I DONOT HAVE DRIVING LICENCE" onclick="EnableDisableTB();">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-12 check-controls">
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <input type="number" name="licenceNumber" id="licenceNumber"
                                        placeholder="name@licenceNumber.com"
                                        class="form-control @error('licenceNumber') is-invalid @enderror"
                                        value="{{old('licenceNumber')}}" disabled>
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <input type="date" name="issueddate" id="issueddate"
                                        placeholder="name@issueddate.com"
                                        class="form-control @error('issueddate') is-invalid @enderror"
                                        value="{{old('issueddate')}}" disabled>
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <input type="date" name="expiredate" id="expiredate"
                                        placeholder="name@expiredate.com"
                                        class="form-control @error('expiredate') is-invalid @enderror"
                                        value="{{old('expiredate')}}" disabled>
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <input type="text" name="issuedcity" id="issuedcity"
                                        placeholder="name@issuedcity.com"
                                        class="form-control @error('issuedcity') is-invalid @enderror"
                                        value="{{old('issuedcity')}}" disabled>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-12 check-controls">
                            ...
                            <div class="form-check check-modifier">
                                <input type="radio" name="transport" id="own-transport"
                                    class="form-check-input @error('transport') is-invalid @enderror"
                                    value="YES I I HAVE MY TRANSPORT">
                                <label class=" form-check-label" for="own-transport">YES</label>
                            </div>
                            <div class="form-check check-modifier">
                                <input type="radio" name="transport" id="no-transport"
                                    class="form-check-input @error('transport') is-invalid @enderror"
                                    value="NO I DONOT HAVE NO TRANSPORT">
                    ...
                    <div class="form-group">
                        <input type="submit" name="submit" id="submit" class="btn py-3 px-5 btn-primary btn-sm"
                            value="Submit Form" disabled>
                    </div>
                </form>
