<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="description">
        {{ __('Here you can edit the account details including name, email, phone number, Country and State') }}
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="nationality" type="text" class="mt-1 block w-full" wire:model.defer="state.nationality"
                required autocomplete="nationality" />
            <x-input-error for="nationality" class="mt-2" />
        </div>
        <!-- state -->
        <div class="col-span-6 sm:col-span-4">
            <x-label for="phone" value="{{ __('State') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="street" type="text" class="mt-1 block w-full" wire:model.defer="state.street" required
                autocomplete="street" />
