...
/*function validateGender(){
	...
	if(gender.checked== false){
		genderError.innerHTML='Select driving licence status';
	}
		genderError.innerHTML =  '<i class="icon-check-circle"></i>';
	return true;
}
*/
...
function validatelicencenumber(){
	...
	if(licenceNumber.length < 6){
		licencenumberError.innerHTML = 'Licence is a 6 to  9 Characters';
		return false;
	}
	if(licenceNumber.length > 10){
		licencenumberError.innerHTML = 'You Exceeded Licence Format';
		return false;
	}
...
function EnableDisableTB() {
		...
		if (!licenceNumber.disabled && !issuedcityCheck.disabled && !issueddateCheck.disabled && !expiredateCheck.disabled ) {
...
function  validateApplication(){
		...
		if(!validateFname() || !validateSname() || !validateSaddress() || !validateCity() || !validateState() ||!validateZip() || !validateEmail() || !validatePhone() || !validateAge()  || !validateBirthdate() || !validatesocialsecurityNumber() || !validateeinNumber() || !validateStartTime()   || !validateEndtime() || !validateStartdate() || !validateWorkperiod() || !validateWorkHours()  || !validatelicencenumber()  || !validateLicenceIssueddate() || !validateLicenceExpiredate()|| !validateissuedcity() )
	{
